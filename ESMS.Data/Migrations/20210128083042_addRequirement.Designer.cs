...
namespace ESMS.Data.Migrations
{
    ...
    [Migration("20210128083042_addRequirement")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ESMS.Data.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "5907b6e1-c035-4bf8-9919-5e14f9dd1cda",
                            DateCreated = new DateTime(2021, 1, 28, 15, 30, 41, 512, DateTimeKind.Local).AddTicks(3717),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEIR66WvHHaDcj4uilGrkoirRoG/AOY+G8P1ayJxme3EL97IR+44MZukoXPEMbmximw==",
            ...
            modelBuilder.Entity("ESMS.Data.Entities.PositionRequirement", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ESMS.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "e614403e-6de5-448a-8671-a2e9c70d3d98",
            ...
            modelBuilder.Entity("ESMS.Data.Entities.SkillRequirement", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("PositionRequirementID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PositionRequirementID");
            ...
            modelBuilder.Entity("ESMS.Data.Entities.SkillRequirement", b =>
                {
                    b.HasOne("ESMS.Data.Entities.PositionRequirement", "PositionRequirement")
                        .WithMany("SkillRequirements")
                        .HasForeignKey("PositionRequirementID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("PositionRequirement");
