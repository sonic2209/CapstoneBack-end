...
namespace ESMS.Data.Migrations
{
    ...
    [Migration("20210410090442_removeStakeHolder")]
    partial class removeStakeHolder
    {
            ...
            modelBuilder.Entity("ESMS.Data.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "99b5ac78-df04-4108-9cc1-8836b0f6ba9e",
                            DateCreated = new DateTime(2021, 4, 10, 16, 4, 41, 635, DateTimeKind.Local).AddTicks(1994),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBEUssk3v6T/k25nIGawc579y3YTlYK05HAQMh32U3+RH7MpCvxamyB3mRI9FqKF3w==",
            ...
            modelBuilder.Entity("ESMS.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "ff758830-1f36-4ce1-bbd6-da07c0987973",
